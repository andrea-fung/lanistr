...
def print_pretrain_performance_by_main_process(
  ...
  if is_main_process():
    ...
    logger.info(
        ...
        epoch + 1,
        num_epochs,
        train_results["ptrLoss"],
        train_results["ptrMLM"],
        train_results["ptrMIM"],
        train_results["ptrMTM"],
        train_results["ptrMFM"],
        train_results["ptrMMM"],
        valid_results["ptrLoss"],
        valid_results["ptrMLM"],
        valid_results["ptrMIM"],
        valid_results["ptrMTM"],
        valid_results["ptrMFM"],
        valid_results["ptrMMM"],
    )
  ...
  if is_main_process():
    ...
    if metric_name == "Loss":
      logger.info(
          ...
          epoch + 1,
          num_epochs,
          train_results["trLoss"],
          valid_results["valLoss"],
      )
    else:
      logger.info(
          (
          ...
          num_epochs,
          train_results["trLoss"],
          train_results["tr"+metric_name],
          valid_results["valLoss"],
          valid_results["val"+metric_name],
          metric_name,
          best_perf,
      )
